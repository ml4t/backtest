...
__pdoc__["orders_field_config"] = f"""Field configuration for `Orders`.
...
__pdoc__["orders_attach_field_config"] = f"""Configuration for fields to be attached to `Orders`.
...
__pdoc__["orders_shortcut_config"] = f"""Shortcut properties configuration for `Orders`.
...
__pdoc__["fs_orders_field_config"] = f"""Field configuration for `FSOrders`.
...
__pdoc__["fs_orders_attach_field_config"] = f"""Field attachment configuration for `FSOrders`.
...
__pdoc__["fs_orders_shortcut_config"] = f"""Shortcut properties configuration for `FSOrders`.
