    ...
    dict(
        ...
        settings=dict(
            ...
            req_price_area_vio_mode=dict(
                title="[REQ] Price Area Violation Mode", mapping=PriceAreaVioMode
            ),
...
__pdoc__["logs_field_config"] = f"""Field configuration for `Logs`.
...
__pdoc__["logs_attach_field_config"] = f"""Field attachment configuration for `Logs`.
