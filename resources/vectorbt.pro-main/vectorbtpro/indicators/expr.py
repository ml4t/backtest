...
__pdoc__["expr_func_config"] = f"""Configuration for functions used in indicator expressions.
...
__pdoc__["wqa101_expr_config"] = f"""Configuration for WorldQuant's 101 alpha expressions.
