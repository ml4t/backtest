...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        formatter_class=argparse.ArgumentDefaultsHelpFormatter, description="Run InfluxDB Import"
    )
    ...
    exoptgroup.add_argument(
        "--ticker-list", action="store", default=None, help="Path to folder to create files."
    )
    parser.add_argument(
        "--host", required=False, action="store", default=None, help="InfluxDB hostname."
    )
    parser.add_argument(
        "--port",
        required=False,
    ...
    parser.add_argument(
        "--username", required=False, action="store", default=None, help="InfluxDB username."
    )
    parser.add_argument(
        "--password", required=False, action="store", default=None, help="InfluxDB password."
    )
    parser.add_argument(
        "--database", required=False, action="store", default=None, help="InfluxDB database to use."
    )
    parser.add_argument(
        "--sourcepath",
        required=False,
    ...
    parser.add_argument(
        "--debug", required=False, action="store_true", help="Turn on debug logging level."
    )
    parser.add_argument(
        "--info", required=False, action="store_true", help="Turn on info logging level."
    )
