...
def parse_args(pargs=None):
    parser = argparse.ArgumentParser(
        formatter_class=argparse.ArgumentDefaultsHelpFormatter, description=("Renko bricks sample")
    )
    ...
    parser.add_argument(
        "--renko", required=False, default="", metavar="kwargs", help="kwargs in key=value format"
    )
