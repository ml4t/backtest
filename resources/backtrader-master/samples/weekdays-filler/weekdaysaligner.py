...
def parse_args():
    ...
    parser.add_argument(
        "--online", required=False, action="store_true", help="Fetch data online from Yahoo"
    )
    ...
    parser.add_argument(
        "--filler", required=False, action="store_true", help="Add Filler to Datas 0 and 1"
    )
    ...
    parser.add_argument(
        "--fromdate", "-f", default="2012-01-01", help="Starting date in YYYY-MM-DD format"
    )
