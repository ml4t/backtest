...
def parse_args(pargs=None):
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Gold vs SP500 from https://estrategiastrading.com/oro-bolsa-estadistica-con-python/"
        ),
    )

    parser.add_argument(
        "--data0", required=False, default="SPY", metavar="TICKER", help="Yahoo ticker to download"
    )

    parser.add_argument(
        "--data1", required=False, default="GLD", metavar="TICKER", help="Yahoo ticker to download"
    )
