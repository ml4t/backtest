...
def parse_args():
    parser = argparse.ArgumentParser(
        formatter_class=argparse.ArgumentDefaultsHelpFormatter, description="Volume Filling Sample"
    )
    ...
    parser.add_argument(
        "--cash", required=False, action="store", default=500e6, type=float, help=("Starting cash")
    )
    ...
    parser.add_argument(
        "--fromdate", "-f", required=False, default=None, help="Starting date in YYYY-MM-DD format"
    )

    parser.add_argument(
        "--todate", "-t", required=False, default=None, help="Ending date in YYYY-MM-DD format"
    )
