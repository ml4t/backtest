...
def parse_args():
    ...
    parser.add_argument(
        "--nomacdplot", "-nm", action="store_true", help="Hide the indicator from the plot"
    )
    ...
    group.add_argument(
        "--rsioversma", "-rom", action="store_true", help="Plot the RSI indicator on the SMA axis"
    )
    ...
    parser.add_argument(
        "--stocrsilabels", action="store_true", help="Plot line names instead of indicator name"
    )
