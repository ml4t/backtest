...
def parse_args():
    parser = argparse.ArgumentParser(
        formatter_class=argparse.ArgumentDefaultsHelpFormatter, description="BidAsk to OHLC"
    )

    parser.add_argument(
        "--data", required=False, default="../../datas/bidask2.csv", help="Data file to be read in"
    )

    parser.add_argument(
        "--compression", required=False, default=2, type=int, help="How much to compress the bars"
    )
