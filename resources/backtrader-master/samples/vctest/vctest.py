...
def parse_args():
    ...
    parser.add_argument(
        "--nostore", required=False, action="store_true", help="Do not Use the store pattern"
    )
    ...
    parser.add_argument(
        "--broker", required=False, action="store_true", help="Use VisualChart as broker"
    )
    ...
    parser.add_argument(
        "--valid", default=None, required=False, action="store", help="Seconds or YYYY-MM-DD"
    )
