...
def parse_args():
    parser = argparse.ArgumentParser(
        formatter_class=argparse.ArgumentDefaultsHelpFormatter, description="Check Memory Savings"
    )
    ...
    parser.add_argument(
        "--save", required=False, type=int, default=0, help=("Memory saving level [1, 0, -1, -2]")
    )
