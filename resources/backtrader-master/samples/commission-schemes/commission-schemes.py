...
def parse_args():
    ...
    parser.add_argument(
        "--period", default=30, type=int, help="Period to apply to the Simple Moving Average"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        help=(
            "Commission factor for operation, either apercentage or a per stake unit absolute value"
        ),
    )
    ...
    parser.add_argument(
        "--margin", default=2000.0, type=float, help="Margin for futures-like operations"
    )
