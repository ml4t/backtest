...
def parse_args(pargs=None):
    ...
    parser.add_argument(
        "--todate", required=False, default="2015-12-31", help="Ending date in YYYY-MM-DD format"
    )

    parser.add_argument(
        "--stake", required=False, action="store", default=10, type=int, help=("Stake size")
    )

    parser.add_argument("--short", required=False, action="store_true", help=("Go short too"))
    ...
    parser.add_argument("--printout", required=False, action="store_true", help=("Print infos"))
