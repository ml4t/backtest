...
def parse_args():
    ...
    parser.add_argument(
        "--debug", required=False, action="store_true", help="Display all info received form IB"
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Do not Use TWS/System time offset for non timestamped prices and to align resampling"
        ),
    )
    ...
    parser.add_argument(
        "--donotsell", required=False, action="store_true", help="Do not sell after a buy"
    )
    ...
    pgroup.add_argument(
        "--oca", required=False, action="store_true", help="Test oca by putting 2 orders in a group"
    )
