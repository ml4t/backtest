...
def parse_args():
    ...
    parser.add_argument(
        "--data0", "-d0", default="../../datas/orcl-2003-2005.txt", help="1st data into the system"
    )

    parser.add_argument(
        "--data1", "-d1", default="../../datas/yhoo-2003-2005.txt", help="2nd data into the system"
    )

    parser.add_argument(
        "--fromdate", "-f", default="2003-01-01", help="Starting date in YYYY-MM-DD format"
    )

    parser.add_argument(
        "--todate", "-t", default="2005-12-31", help="Starting date in YYYY-MM-DD format"
    )

    parser.add_argument(
        "--period", default=15, type=int, help="Period to apply to the Simple Moving Average"
    )
