...
def parse_args(pargs=None):
    ...
    parser.add_argument(
        "--offline", required=False, action="store_true", help="Use offline file with ticker name"
    )

    parser.add_argument(
        "--data", required=False, default="^GSPC", metavar="TICKER", help="Yahoo ticker to download"
    )
