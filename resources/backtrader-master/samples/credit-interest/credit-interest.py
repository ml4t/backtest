...
def parse_args(pargs=None):
    parser = argparse.ArgumentParser(
        formatter_class=argparse.ArgumentDefaultsHelpFormatter, description="Sample for Slippage"
    )
    ...
    parser.add_argument(
        "--no-int2pnl", required=False, action="store_false", help=("Do not assign interest to pnl")
    )
    ...
    parser.add_argument(
        "--stake", required=False, action="store", default=10, type=int, help=("Stake to apply")
    )
