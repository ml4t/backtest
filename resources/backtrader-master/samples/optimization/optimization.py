...
def parse_args():
    ...
    parser.add_argument(
        "--data", "-d", default="../../datas/2006-day-001.txt", help="data to add to the system"
    )

    parser.add_argument(
        "--fromdate", "-f", default="2006-01-01", help="Starting date in YYYY-MM-DD format"
    )

    parser.add_argument(
        "--todate", "-t", default="2006-12-31", help="Starting date in YYYY-MM-DD format"
    )
    ...
    parser.add_argument(
        "--ma_low", type=int, default=10, required=False, help="SMA range low to optimize"
    )

    parser.add_argument(
        "--ma_high", type=int, default=30, required=False, help="SMA range high to optimize"
    )

    parser.add_argument(
        "--m1_low", type=int, default=12, required=False, help="MACD Fast MA range low to optimize"
    )
    ...
    parser.add_argument(
        "--m2_low", type=int, default=26, required=False, help="MACD Slow MA range low to optimize"
    )
    ...
    parser.add_argument(
        "--m3_low", type=int, default=9, required=False, help="MACD Signal range low to optimize"
    )

    parser.add_argument(
        "--m3_high", type=int, default=15, required=False, help="MACD Signal range high to optimize"
    )
