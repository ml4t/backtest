...
def parse_args(pargs=None):
    ...
    pgroup.add_argument(
        "--target-size", required=False, action="store_true", help=("Use order_target_size")
    )

    pgroup.add_argument(
        "--target-value", required=False, action="store_true", help=("Use order_target_value")
    )

    pgroup.add_argument(
        "--target-percent", required=False, action="store_true", help=("Use order_target_percent")
    )
