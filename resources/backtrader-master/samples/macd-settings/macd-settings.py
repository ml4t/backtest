...
def runstrat(args=None):
    ...
    cerebro.addanalyzer(
        bt.analyzers.TimeReturn, data=data0, _name="benchmark", timeframe=bt.TimeFrame.NoTimeFrame
    )
    ...
    # Add a SharpeRatio
    cerebro.addanalyzer(
        bt.analyzers.SharpeRatio, timeframe=bt.TimeFrame.Years, riskfreerate=args.riskfreerate
    )
