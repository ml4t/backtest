...
class TestSizer(bt.Sizer):
    ...
    def _getsizing(self, comminfo, cash, data, isbuy):
        ...
        print(
            "{} Data {} OType {} Sizing to {}".format(dt, data._name, ("buy" * isbuy) or "sell", s)
        )
...
def parse_args(pargs=None):
    ...
    parser.add_argument(
        "--data0", default="../../datas/nvda-1999-2014.txt", required=False, help="Data0 to read in"
    )

    parser.add_argument(
        "--data1", default="../../datas/yhoo-1996-2014.txt", required=False, help="Data1 to read in"
    )

    parser.add_argument(
        "--data2", default="../../datas/orcl-1995-2014.txt", required=False, help="Data1 to read in"
    )
