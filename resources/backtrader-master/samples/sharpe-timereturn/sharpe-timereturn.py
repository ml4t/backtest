...
def parse_args(pargs=None):
    ...
    parser.add_argument(
        "--fromdate", "-f", default="2005-01-01", help="Starting date in YYYY-MM-DD format"
    )
    ...
    parser.add_argument(
        "--writercsv", "-wcsv", action="store_true", help="Tell the writer to produce a csv stream"
    )
    ...
    parser.add_argument(
        "--annualize", required=False, action="store_true", help="Annualize Sharpe Ratio"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help=("Riskfree Rate conversion factor for Sharpe to downgrade riskfree rate to timeframe"),
    )
    ...
    parser.add_argument(
        ...
        required=False,
        action="store_true",
        help=("Upgrade returns to target timeframe rather thandowngrading the riskfreerate"),
    )
