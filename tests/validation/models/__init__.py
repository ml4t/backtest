...
to ensure ml4t.backtest produces identical results to reference implementations.
...
Import these ONLY from tests/validation/, never from src/ml4t.backtest production code.
"""
