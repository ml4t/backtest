#!/usr/bin/env python3
"""Scenario 07: Fixed Slippage validation against Backtrader.

Backtrader supports fixed slippage via FixedSlipDealer.

Run from .venv-validation environment:
    source .venv-validation/bin/activate
    python validation/backtrader/scenario_07_slippage_fixed.py
"""
...
def run_backtrader(prices_df: pd.DataFrame, entries: np.ndarray, exits: np.ndarray) -> dict:
    ...
    cerebro.broker.set_slippage_fixed(SLIPPAGE_AMOUNT)
