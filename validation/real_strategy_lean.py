        ...
        json.dumps(
            {
                ...
                "parameters": {},
                "description": f"Frozen ML4T {case_study} real-strategy parity workload",
            },
            indent=2,
        )
        + "\n",
...
class RealStrategyEquities(QCAlgorithm):
    def initialize(self):
