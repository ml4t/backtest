...
```
FillSimulator._calculate_fill_price():
  src/qengine/execution/fill_simulator.py:456-494
...
Broker.on_market_event() - TSL processing:
  src/qengine/execution/broker.py:720-767
...
1. **src/qengine/data/asset_registry.py** (Line 43-45)
   - Default precision: 8 decimals

2. **src/qengine/execution/broker.py** (3 locations)
