...
**Location**: `src/ml4t.backtest/execution/fill_simulator.py` around line 215-221
...
Order default precision:
  src/ml4t.backtest/execution/order.py:130
  position_decimals=8

Portfolio default precision:
  src/ml4t.backtest/execution/broker.py:127
  position_decimals=8

FillSimulator (check for precision issues):
  src/ml4t.backtest/execution/fill_simulator.py:215-221
```
...
1. **src/ml4t.backtest/execution/order.py**
