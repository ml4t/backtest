# ml4t.backtest Phase 1 Redesign - 80% Complete
...
Removed EventBus class entirely from `src/ml4t.backtest/core/event.py`:
...
Added pub-sub pattern to Clock (`src/ml4t.backtest/core/clock.py`):
...
Updated `src/ml4t.backtest/engine.py`:
...
**Core changes**:
- `src/ml4t.backtest/core/event.py` - EventBus deleted (-134 lines)
- `src/ml4t.backtest/core/clock.py` - pub-sub pattern added (+84 lines)
- `src/ml4t.backtest/engine.py` - Clock-driven loop implemented (-77 lines main loop, +30 new)
- `src/ml4t.backtest/__init__.py` - EventBus removed from exports
- `src/ml4t.backtest/core/__init__.py` - EventBus removed from exports
...
2. **`src/ml4t.backtest/core/clock.py`** - New pub-sub methods (lines 111-187)
3. **`src/ml4t.backtest/engine.py`** - New event loop (lines 174-206)
