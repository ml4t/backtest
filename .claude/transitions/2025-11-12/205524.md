...
**Modified:**
1. `src/ml4t.backtest/execution/broker.py` - Major refactoring
...
2. `src/ml4t.backtest/portfolio/portfolio.py` - Backward compatibility
...
2. `src/ml4t.backtest/portfolio/core.py` (179 lines) - Phase 1
3. `src/ml4t.backtest/portfolio/analytics.py` (125 lines) - Phase 2
4. `src/ml4t.backtest/portfolio/portfolio.py` (334 lines) - Phase 4
...
M src/ml4t.backtest/portfolio/portfolio.py
...
- Broker integration strategy is ml4t.backtest-specific
